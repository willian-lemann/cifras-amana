...
export default function SignInPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      logErrorToSentry(error as Error, { location: "login submit" });
  ...
  return (
    <div className="from-muted/30 to-background flex items-center justify-center bg-gradient-to-br p-4">
      <Card className="w-full max-w-sm ring-0">
        <CardHeader className="text-center">
          <Link
            href="/"
            className="mb-4 inline-flex items-center justify-center gap-0"
          >
