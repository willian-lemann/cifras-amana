...
export type ComparisonItemProps = ComponentProps<typeof m.div> & {
  position: "left" | "right";
};
...
export type ComparisonHandleProps = ComponentProps<typeof m.div> & {
  children?: ReactNode;
};
...
export const ComparisonHandle = ({
  ...
  return (
    ...
    >
      {children ?? (
        <>
          <div className="bg-background/80 absolute left-1/2 h-full w-1 -translate-x-1/2" />
          {mode === "drag" && (
